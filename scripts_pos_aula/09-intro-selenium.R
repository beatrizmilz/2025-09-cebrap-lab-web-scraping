...
# Capturar a tela
drv$client$screenshot(file = "screenshot_cebrap.png")

drv$client$goForward()

# Buscando o código fonte (HTML) da página

page_source <- drv$client$getPageSource()
...
readr::write_csv(cursos_cebrap, "cursos_cebrap.csv")
